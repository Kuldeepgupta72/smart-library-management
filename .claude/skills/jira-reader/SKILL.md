---
name: jira-reader
description: Fetch a single story or query the backlog from Jira via REST API. GET-only, never creates/updates/deletes issues. Use when jira-agent needs to browse the AISDLC backlog or fetch one story's details.
---
